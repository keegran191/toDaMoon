...
function AdminManagement({ cookies }) {
    ...
    const GetAdminHistory = () => {
        Axios.get(`http://localhost:3000/api/Order/getafminhistory`).then((response) => {
    ...
    const GetAdminOrder = () => {
        Axios.get(`http://localhost:3000/api/Order/getadminorder`).then((response) => {
    ...
    return (
        <div className='select-none'>
            ...
            <div className='mt-20 flex px-10 justify-center lg:justify-start h-auto'>
                ...
                {/* order */}
                {lookOrder && <div className='w-8/12 mt9 lg:pl-10'>
                    <h1 className=' text-xl'>รายการคำสั่งซื้อ</h1>
                ...
                {/* history */}
                {lookHistory && <div className='w-8/12 mt9 lg:pl-10'>
