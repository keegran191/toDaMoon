    ...
    return(
        <div>
            ...
            <main>
                ...
                <form class={style.form} action="/api/register2" method='POST' >
                    <h1 class="text-center sm:text-5xl text-4xl mt-36 mb-10 w-full">{errorMsg}สมัครสมาชิก</h1>
                    <div class="relative z-0 mb-6 w-full group">
                        ...
                        <div class="w-full">
                            {errorMsg == "UserAlreadyExists" &&<span id="alreadyExist" class="text-[#ff0000] block">Email ถูกใช้ไปแล้ว</span>}
                        </div>
                    </div>
                    ...
                    <button id="register" type="submit" class="w-full text-white bg-[#252525] hover:bg-[#010101] font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-[#252525] dark:hover:bg-[#010101] focus:outline-none">สมัครสมาชิก</button>
                    <Link href="/login">
