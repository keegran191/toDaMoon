    ...
    return (
        <nav className="sticky top-0 w-full z-20 bg-[#252525] sm:px-4 py-2.5 dark:bg-[#252525]">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className = {toggle? "hidden md:block": "" + "w-full sm:block md:w-auto h-screen xl:hidden"} id="navbar-default">
                    <ul className="flex flex-col p-4 mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-[#252525] bg-[#252525] dark:border-[#252525]">
                        ...
                        <li>
                            <button data-dropdown-toggle="dropdownNavbar" onClick={()=> {toggleBtn(toggle1, setToggle1)}} className="flex justify-between items-center py-2 pr-4 pl-3 w-full font-medium text-white rounded md:border-0 md:text-white md:p-0 md:w-auto">จัดการประเภทของสินค้า <svg className="ml-1 w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></button>
                        ...
                        <li>
                            <button data-dropdown-toggle="dropdownNavbar" onClick={()=> {toggleBtn(toggle2, setToggle2)}} className="flex justify-between items-center py-2 pr-4 pl-3 w-full font-medium text-white rounded md:border-0 md:text-white md:p-0 md:w-auto">จัดการสินค้า <svg className="ml-1 w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></button>
                        ...
                        <li className='block sm:hidden xl:block'>
                        ...
                        <li className='flex w-full justify-center sm:hidden xl:block mt-10'>
