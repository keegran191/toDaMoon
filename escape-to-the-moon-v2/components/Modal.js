            ...
            <div className="relative w-full shadow-2xl rounded-lg max-w-md md:h-auto">
                <div className="relative bg-[#252525] rounded-lg shadow">
                    ...
                    <div className="p-6 text-center">
                        ...
                        <button onClick={() => {
                            if(onApply) onApply();
                        }} data-modal-hide="popup-modal" type="button" className="text-white bg-red-800 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            { txtApply }
                        </button>
                        <button onClick={() => {
                            if(onClose) onClose();
                        }} data-modal-hide="popup-modal" type="button" className="text-gray-500 bg-white hover:bg-gray-100  rounded-lg text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-500">{txtClose}</button>
                    </div>
                </div>
            </div>
        </div>
